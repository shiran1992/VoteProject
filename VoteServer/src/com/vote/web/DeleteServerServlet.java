...
public class DeleteServerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(service.deleteServerBySid(Integer.parseInt(ids[0]))){
			request.setAttribute("servers", new ServerService().getServersByPage());
			request.getRequestDispatcher("/list_servers.jsp").
